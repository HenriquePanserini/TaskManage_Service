...
public class AppDbContext : IdentityDbContext<Usuario>
{
    ...
    {
        string strcon = "Data Source=DESKTOP-JDDJMQ9\\SQLEXPRESS;Initial Catalog=AULA_API_DDD_2021;Integrated Security=False;User ID=sa;Password=1234;Connect Timeout=15;Encrypt=False;TrustServerCertificate=False";
        return strcon;
    }
}